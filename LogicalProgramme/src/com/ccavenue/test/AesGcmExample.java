...
public class AesGcmExample {
	...
	public AesGcmExample(String workingKey) throws Exception{
	...
	public static void main(String[] args) {
		...
		try {
			AesGcmExample vAesGcmCryptUtil=new AesGcmExample(encKey);
			String cipherText=vAesGcmCryptUtil.encrypt(plainText);
			System.out.println("encrypt text AES GCM mode ::" + cipherText.toUpperCase());
			System.out.println("decrypt text AES GCM mode ::" + vAesGcmCryptUtil.decrypt(cipherText));
		}
		catch (Exception ex) {
